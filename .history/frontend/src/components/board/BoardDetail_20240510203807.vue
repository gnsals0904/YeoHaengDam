        ...
        <div class="space-y-6">
          ...
          <div class="flex items-start space-x-4">
            ...
            <d class="flex-1">
              ...
              <div class="mt-6 border-t pt-6 dark:border-gray-800 lg:mt-0 lg:border-t-0 lg:pt-0 lg:pl-6">
      <h3 class="text-lg font-bold">Comments</h3>
      <div class="space-y-6">
        <div class="flex items-start space-x-4">
          <div class="flex-1">
            ...
            <div class="mt-2 text-sm">This t-shirt looks amazing! I love the unique prism design.</div>
          </div>
          <span class="relative flex shrink-0 overflow-hidden rounded-full w-10 h-10 border">
            <span class="flex h-full w-full items-center justify-center rounded-full bg-muted">AC</span>
          </span>
        </div>
        <div class="flex items-start space-x-4">
          <div class="flex-1">
