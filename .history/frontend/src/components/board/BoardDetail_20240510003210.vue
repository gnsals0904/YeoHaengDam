        ...
        >
          ...
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              <h2 class="text-2xl font-bold">Introducing the Acme Prism T-Shirt</h2>
              <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
                <div>
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="mr-1 inline-block h-4 w-4 fill-primary"
                  >
                    <path
            ...
            <div class="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
              <div>Olivia Davis</div>
              <div>•</div>
              <div>May 9, 2024</div>
            </div>
            <div class="prose prose-sm dark:prose-invert">
              <p>
                Introducing the Acme Prism T-Shirt, a perfect blend of style and comfort for the
                modern individual. This tee is crafted with a meticulous composition of 60% combed
                ringspun cotton and 40% polyester jersey, ensuring a soft and breathable fabric that
                feels gentle against the skin.
              </p>
              <p>
                The design of the Acme Prism T-Shirt is as striking as it is comfortable. The shirt
                features a unique prism-inspired pattern that adds a modern and eye-catching touch
                to your ensemble.
              </p>
            </div>
          </div>
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <div class="mt-2 text-sm">
                    I can't wait to get my hands on this t-shirt! The quality and design look
                    top-notch.
                  </div>
                </div>
              </div>
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <div class="mt-2 text-sm">
                    The prism design is so unique and eye-catching. I can't wait to see this in
                    person.
                  </div>
                </div>
              </div>
