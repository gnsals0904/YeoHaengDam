<template>
  <RouterLink
    :to="{ name: 'detail', params: { articleNo: board.articleNo } }"
    @click.native="loadDetail(board.articleNo)"
  >
    <div
...
// Define props received by the BoardCard component.
...
function loadDetail(articleNo) {
  boardStore.getArticle(articleNo);
