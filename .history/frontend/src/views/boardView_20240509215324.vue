  ...
  <div class="container px-4 md:px-6">
    ...
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Serene Shores of Bali</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">John Doe</span> • May 1, 2023
          </div>
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Enchanting Landscapes of Iceland</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">Jane Smith</span> • June 15, 2023
          </div>
          <div class="text-gray-300 text-sm mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Vibrant Vistas of Santorini</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">Michael Johnson</span> • July 10, 2023
          </div>
          <div class="text-gray-300 text-sm mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Captivating Coastlines of Amalfi</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">Emily Davis</span> • August 5, 2023
          </div>
          <div class="text-gray-300 text-sm mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Majestic Mountains of Patagonia</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">David Lee</span> • September 20, 2023
          </div>
          <div class="text-gray-300 text-sm mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        />
        <div class="absolute inset-0 z-10 flex flex-col justify-end p-4 bg-gradient-to-t from-gray-900/80 to-transparent">
          <div class="text-white text-lg font-semibold group-hover:underline">Enchanting Landscapes of Tuscany</div>
          <div class="text-gray-300 text-sm">
            <span class="font-medium">Sarah Kim</span> • October 1, 2023
          </div>
          <div class="text-gray-300 text-sm mt-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
